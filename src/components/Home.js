...
export default function Home() {
  ...
  const Me = (type) => {
    axios.get(`http://localhost:4002/products?type=${type}`)
      .then((res) => {
        setpr(res.data);
      })
      .catch((e) => {
  ...
  const findd = () => {
    axios.get(`http://localhost:4002/products?name=${sear}`)
      .then((res) => {
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: "20px", backgroundColor: "orange" }}>
